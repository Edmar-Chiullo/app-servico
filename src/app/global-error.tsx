  ...
  return (
    <html lang="pt-BR">
      <body className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm max-w-md w-full text-center p-8">
          ...
          <p className="text-gray-500 mb-6 text-sm">
            Ocorreu um erro na estrutura principal da aplicação. Recarregue a página.
          </p>
          {error.digest && (
